...
svglite('figs/Implicit learning.svg', width = 12, height = 4, system_fonts=list(sans = "Arial"))
...
svglite('figs/Model Fits.svg', width = 12, height = 8, system_fonts=list(sans = "Arial"))
...
Ttestdata<- PrepdataforT(active_reaches, passive_reaches, pause_reaches[33:320,], nocursor_reaches[33:320,], nocursor_nocursors, nocursorI_reaches[33:320,], nocursorI_nocursors, terminal_reaches)
